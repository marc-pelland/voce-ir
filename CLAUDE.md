...
| S79 (agent capability surface) | In progress — A1 Slice 1 shipped: `voce skills [--json]` reflected manifest (9 passes / 52 codes / 27 node types / 7 targets / 12 CLI commands), `contract_version: 1.0.0`. Remaining: A1 Slice 2 (MCP parity), A2 doctor, A3 graph, A4 JSON Schemas, A5 conformance runner, Part B |
