...
| S60 (community launch / v1.1.0) | In progress — Slice 1 (README discoverability) + Slice 3 (repo polish: CHANGELOG regen, 3rd issue template) + Slice 5 (launch content drafts: blog post / Show HN / X thread / demo-video shot list under `docs/launch/`) shipped. Remaining: Slice 2 packaging (credentials needed), Slice 4 community infra (GitHub/Discord UI), Slice 6 v1.1.0 tag |
